...
<?php
  $i = 0;
?>
  @foreach($materiallens as $materiallen)
  <?php
    $id = "matlen".(string)($i);
  ?>
  @if($i==0)
  <div id=<?php echo $id?>>
    <div class="form-group">
      ...
      <div class="col-md-5 col-sm-5 col-xs-5">
        {!!Form::text('namematerialLens[]', $materiallen->name, ['id'=>'namematerialLens','class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Material del lente'])!!}
      </div>
      <a class="btn btn-success" id="Addml"><i class="fa fa-plus"></i> Agregar</a>
    </div>
  </div>
  @else
  <div id=<?php echo $id?>>
    ...
    <div class="form-group">
      ...
      <a class="btn btn-danger" id="Subml"><i class="fa fa-minus"></i> Eliminar</a>
    </div>
  </div>
  @endif
  <?php
